...
from app.event_handler.schemas.internal import InternalGameStartEvent, KickEvent, PlayerJoinedEvent
...
@internal_event("kick", KickEvent)
async def kick_player(handler: EventHandlerProtocol, event: KickEvent) -> None:
    await handler.con_manager.broadcast(
